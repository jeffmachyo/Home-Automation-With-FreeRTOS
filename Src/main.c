...
TaskProfiler Thread1_Profile, Thread2_Profile,Default_Profile;
...
void Thread2Function(void const * argument);
...
int main(void)
{
  ...
  osThreadDef(Thread2, Thread2Function, osPriorityNormal, 0, 128);
  ...
  /* Start scheduler */
  osKernelStart();
//  HAL_ADC_Start_DMA(&hadc1, &inputVal, 1);
...
/* USER CODE BEGIN Header_Thread2Function */
/**
* @brief Function implementing the Thread2 thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_Thread2Function */
void Thread2Function(void const * argument)
{

  /* USER CODE BEGIN Thread2Function */
  /* Infinite loop */
  for(;;)
  {

	  sprintf(ADC_Tx_Data,"%i\n",(int)inputVal);
	  HAL_SPI_Transmit_DMA(&hspi1, (uint8_t*)ADC_Tx_Data, 6);
    osDelay(1);
  }
  /* USER CODE END Thread2Function */
}
